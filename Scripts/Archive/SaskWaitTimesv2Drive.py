...
def doRedirectRequest(url,session):
    ...
    # cookies = {
    #     'ORA_WWV_APP_170': 'ORA_WWV-sQX_xrIij3pE7UC8orf5kaxb',
    # }
...
def firstAjax(session,pageState,areaState):
    ...
    headers = {
        ...
        'Referer': 'https://oapp.saskatoonhealthregion.ca/apex/f?p=170:1:17161117332749:::::',
        'Accept-Language': 'en-US,en;q=0.9',
    }
    ...
    'p_flow_id': '170',
    'p_flow_step_id': '1',
    'p_instance': pageState.url.split('oapp.saskatoonhealthregion.ca/apex/f?p=170:1:')[1].split(':')[0],
    'p_debug': '',
...
def thirdAjax(session,pageState, siteState):
    ...
    headers = {
        ...
        'Sec-Fetch-Mode': 'cors',
        'Sec-Fetch-Dest': 'empty',
        'Referer': 'https://oapp.saskatoonhealthregion.ca/apex/f?p=170:1:17161117332749::NO:::',
        'Accept-Language': 'en-US,en;q=0.9',
    }
    ...
    'p_reload_on_submit': 'S',
    'p_page_submission_id': pageSoup.find('input',{'id':'pPageSubmissionId'})['value'],
    'p_json': '{"pageItems":{"itemsToSubmit":[{"n":"P1_TODAY","v":"'+pageSoup.find('input',{'id':'P1_TODAY'})['value']+'","ck":"'+pageSoup.find('input',{'data-for':'P1_TODAY'})['value']+'"},{"n":"P1_AREA","v":"'+pageSoup.findAll('option',{'selected':True})[0]['value']+'"},{"n":"P1_SITE","v":"'+pageSoup.findAll('option',{'selected':True})[1]['value']+'"},{"n":"P1_NO_DATA","v":"'+pageSoup.find('input',{'id':'P1_NO_DATA'})['value']+'","ck":"'+pageSoup.find('input',{'data-for':'P1_NO_DATA'})['value']+'"}],"protected":"'+pageSoup.find('input',{'id':'pPageItemsProtected'})['value']+'","rowVersion":""},"salt":"'+pageSoup.find('input',{'id':'pSalt'})['value']+'"}'
    }
...
waitTimePageURL = SHAPageSoup.find("div", {"id": "ctl00_PlaceHolderMain_ctl00__ControlWrapper_RichHtmlField"}).findAll('a')[0]['href']
